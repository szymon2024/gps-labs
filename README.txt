...
gps_lab01 - GPS satellite position determined by the receiver based on
            broadcast orbital parameters in accordance with the
            IS‑GPS‑200 specification

gps_lab02 - GPS satellite position based on broadcast
            orbital parameters
